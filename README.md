...
```
venv\Scripts\python scripts\tests\test_pure.py     # 골든 테스트 229건
```
...
| 항목 | 값 |
|---|---|
| 처리량 | 5권 4,302쪽 / 385.7분 · 3권 2,275쪽 / 197분 (쪽당 5.4·6.8초) |
| 페이지 실패 | 0 |
| 그림 추출 | 7,993개 (깨진 링크 0, 고아 파일 0) |
| 본문 유사도 (세대 간) | Dice 99.31~99.98% |
| 본문 유사도 (원본 대비) | 산문 회수 95.6% · 정밀도 98.5% — 중앙값, 504쪽 대조 |
| 인쇄 쪽번호 회수 | 46~97% · 중복·역행 0 (머리말에 쪽번호가 없는 책은 0%) |
| 골든 테스트 | 229건 (모델·외부 프로세스 없이 실행) |
...
| `scripts/tests/test_pure.py` | 순수 함수 골든 테스트 229건 |
